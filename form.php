...
?>
    ...
    text-decoration: wavy;" >REVIEWS</h2>
    ...
    <div class="container">
        ...
        <div class="text">
            ...
            <p style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-weight: 900;">
                At OLYSTAC, I found the winning formula for success. The expert coaching, cutting-edge facilities, and a supportive community create an environment that breeds champions. The comprehensive training modules cater to individual strengths, making it a versatile haven for athletes. It isn't just a training ground; it's the launchpad where medals are forged. My journey to success began here,
                 and I proudly endorse it as the institute that transforms potential into podium moments.</p>
                 <br>
                 <p style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-weight: 900;">Pusarla Venkata Sindhu</p>
                 <p style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-weight: 900;">Olympic Gold Medalist-Badmitton</p>
           <br>
    ...
    <div class="container">
        ...
        <div class="text">
            <p style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-weight: 900;">
                OLYSTAC is the crucible where my wrestling journey transformed into Olympic glory. The expert coaching, cutting-edge facilities, and a community of champions make it an unparalleled training ground. Personalized programs cater to individual strengths, ensuring a holistic development approach. Medals aren't just earned here; they are forged through dedication and world-class training. For any aspiring wrestler, OLYSTAC  is the gateway to realizing championship dreams.
            </p>
            <br>
            
            <p style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-weight: 900;">Ravi Kumar Dahiya</p>          
            <p style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-weight: 900;">Wrestler</p>          
